...
export interface Service {
  ...
  relatedEquipment: string[];  // equipment slugs
    ...
    processSteps: [
      {
        ...
        title: 'Scope & Quote',
        description:
          'Provide equipment list, origin address, and destination. We return a complete scope and fixed price within one business day — no open-ended estimates.',
      },
      {
        step: 2,
        title: 'De-Installation',
        description:
          'Our crew de-installs at the source facility: disconnecting utilities, draining vessels, and preparing equipment for safe load-out with full documentation.',
      },
      {
        step: 3,
        title: 'Load-Out & Freight',
        description:
          'Bonded freight and rigging load-out. Equipment is secured, documented, and shipped under our direct coordination — not handed off to a third-party broker.',
      },
      {
        step: 4,
        title: 'Set & Level',
        description:
          'Installation at the destination. We set, level, and position every vessel to spec. Crane operations, forklift work, and constrained-access installations all handled in-house.',
      },
      {
        step: 5,
        title: 'Utilities & Commissioning',
        description:
          'Utilities connection and startup commissioning. We do not leave until the equipment runs. Every installation includes a commissioning walkthrough with your team.',
      },
    ],
    bestFitScenarios: [
      {
        title: 'Brewery Expansion',
        description:
          'Purchasing additional fermenters, a larger brewhouse, or a canning line? We handle the move from source facility through commissioned installation at your expanded space.',
        icon: 'M12 2v20M2 12h20',
      },
      {
        title: 'Facility Relocation',
        description:
          'Moving your entire operation to a new building? Full facility de-install, transport, and reinstall under a single crew and contract.',
        icon: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z',
      },
      {
        title: 'Equipment Purchase',
        description:
          'Buying used equipment from our inventory or another source? Bundle rigging and installation with the purchase for a single accountable scope.',
        icon: 'M20 7H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2zM16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16',
      },
      {
        title: 'Consignment Pickup',
        description:
          'Selling equipment on consignment through us? We handle de-installation and transport to our San Marcos facility as part of the consignment process.',
...
Consignment is appropriate for: breweries upgrading to larger systems, facilities reducing footprint, partnership dissolutions, and full brewery liquidations. Contact us to discuss your specific situation.`,
    processSteps: [
      {
        ...
        description:
          'We review your equipment list, advise on realistic market pricing based on current demand, and provide an honest timeline estimate. No upfront fees.',
      },
      {
        step: 2,
        title: 'Photography & Documentation',
        description:
          'On-site photography, video walkthroughs, and full condition documentation. High-quality visual presentation is one of the largest drivers of sale price and speed.',
      },
      {
        step: 3,
        title: 'Listing & Marketing',
        description:
          'Equipment is listed on our site, in our buyer network, and across relevant industry platforms. We target qualified buyers — production operators who know what they\'re purchasing.',
      },
      {
        step: 4,
        title: 'Buyer Qualification',
        description:
          'We vet buyers, handle inquiries, and manage negotiations on your behalf. You are not fielding calls from unqualified tire-kickers.',
      },
      {
        step: 5,
        title: 'Sale & Settlement',
        description:
          'Once sold, we coordinate logistics and handle final settlement. Payout is straightforward and transparent per the agreed commission structure.',
      },
    ],
    bestFitScenarios: [
      {
        ...
        description:
          'Replacing a 15 BBL brewhouse with a 30 BBL system? Consign the outgoing equipment to offset the capital cost of the upgrade.',
        icon: 'M5 3l14 9-14 9V3z',
      },
      {
        title: 'Facility Downsizing',
        description:
          'Reducing production capacity or consolidating operations? Consignment recovers value from equipment you no longer need without a fire-sale timeline.',
        icon: 'M19 14l-7 7m0 0l-7-7m7 7V3',
      },
      {
        title: 'Partnership Dissolution',
        description:
          'Splitting brewery assets as part of a business separation? Consignment provides a structured, documented sale process with transparent proceeds.',
        icon: 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75',
      },
      {
        title: 'Full Brewery Liquidation',
        description:
          'Closing your brewery? Consignment handles the full asset set methodically, maximizing recovery on each piece rather than bundling everything at a discount.',
    ...
    faqs: [
      ...
      {
        q: 'Do you pick up equipment or does the seller deliver?',
        a: 'We can coordinate pickup via our rigging team for larger equipment sets. For full facility liquidations, we typically come to the site. Contact us to discuss logistics for your specific situation.',
      },
    ],
...
Contact us to discuss your facility, timeline, and goals. We will advise whether auction, consignment, or direct purchase best serves your situation.`,
    processSteps: [
      {
        step: 1,
        title: 'Facility & Asset Review',
        description:
          'We assess the full equipment set, provide a realistic reserve and gross estimate, and advise on whether auction, consignment, or direct purchase best fits your timeline.',
      },
      {
        step: 2,
        title: 'Inventory & Documentation',
        description:
          'Complete equipment photography, video, lot creation, and condition documentation. Every lot is presented to maximize buyer confidence and bid value.',
      },
      {
        step: 3,
        title: 'Buyer Marketing',
        description:
          'Active marketing to our qualified buyer network — production operators, not general auctioneers. Cross-listed on industry platforms for maximum reach.',
      },
      {
        step: 4,
        title: 'Bidding & Sale',
        description:
          'Live or timed online bidding with buyer qualification. We manage the full bidding process, answer buyer questions, and handle all sale administration.',
      },
      {
        step: 5,
        title: 'Removal & Settlement',
        description:
          'Post-sale rigging coordination, equipment removal scheduling, and final settlement to the seller. Everything handled under one roof.',
      },
    ],
    bestFitScenarios: [
      {
        title: 'Brewery Closure',
        description:
          'Closing your operation and need to recover assets quickly? Auction is the fastest path from full facility to cleared building and settled proceeds.',
        icon: 'M6 18L18 6M6 6l12 12',
      },
      {
        title: 'Facility Consolidation',
        description:
          'Merging two production locations into one? Auction the surplus equipment set efficiently without absorbing the timeline risk of consignment.',
        icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4',
      },
      {
        title: 'Production Line Upgrade',
        description:
          'Replacing an entire canning line or brewhouse system? Auction the outgoing equipment as a lot for faster recovery than piece-by-piece consignment.',
        icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15',
      },
      {
        title: 'Lender or Investor Recovery',
        description:
          'Recovering brewery assets as a lender or investor on a defined legal timeline? Auction provides documented, transparent asset liquidation with clear settlement.',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes. Contact us to register as a buyer and receive advance notice of upcoming events.',
      },
      {
      ...
      {
        q: 'How is auction different from consignment?',
        a: 'Consignment targets maximum recovery over a longer timeline. Auction prioritizes speed — full facility cleared and settled within 30 to 60 days. We advise which approach fits your situation after reviewing the equipment set.',
      },
    ],
...
Contact us to describe your situation and we will advise on what consulting engagement structure makes sense.`,
    processSteps: [
      {
        ...
        description:
          'We start with a conversation — what you are building, buying, or evaluating. No intake form. A direct call with someone who has actually operated production equipment.',
      },
      {
        step: 2,
        title: 'Equipment Evaluation',
        description:
          'For purchase decisions: on-site or remote equipment assessment with condition opinion, pricing context, and operational considerations the seller\'s listing won\'t tell you.',
      },
      {
        step: 3,
        title: 'Capacity & Layout Planning',
        description:
          'For new builds or expansions: capacity modeling, equipment specification, and facility layout review to catch bottlenecks before they become expensive change orders.',
      },
      {
        step: 4,
        title: 'Sourcing Strategy',
        description:
          'New vs. used analysis, manufacturer options, lead time planning, and sequencing the procurement process to keep your build timeline on track.',
      },
      {
        step: 5,
        title: 'Commissioning Support',
        description:
          'On-site or remote support through startup and commissioning. We do not disappear after the sale — we make sure the equipment works.',
      },
    ],
    bestFitScenarios: [
      {
        ...
        description:
          'Planning your first brewery from scratch? We help spec the right equipment for your volume, layout, and capital structure — before you commit to anything.',
        icon: 'M12 4v16m8-8H4',
      },
      {
        title: 'Capacity Expansion',
        description:
          'Adding fermenters, upgrading your brewhouse, or building out a second location? We model capacity requirements and identify the right equipment additions.',
        icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6',
      },
      {
        title: 'Acquisition Due Diligence',
        description:
          'Buying an existing brewery? We provide independent equipment valuation and condition assessment for investors and lenders evaluating asset quality.',
        icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4',
      },
      {
        title: 'Used Equipment Assessment',
        description:
          'Evaluating a specific piece of used equipment from another seller? We provide an independent opinion on condition, pricing, and operational fit before you commit.',
    ...
    faqs: [
      ...
      {
        q: 'Do you only consult on brewery equipment?',
        a: 'Our primary expertise is brewery and craft beverage production equipment. We also have context on distillery, cidery, and kombucha/beverage production equipment from similar systems and manufacturers.',
      },
    ],
    ...
    processSteps: [
      {
        ...
        description:
          'We start with your volume targets, facility constraints, utility infrastructure, and budget. From that we spec a system that actually fits — not the largest one we can sell you.',
      },
      {
        step: 2,
        title: 'Manufacturer Selection',
        description:
          'We match your requirements to our manufacturer relationships — Marks, Specific Mechanical, and others — and provide honest comparisons on lead time, warranty, and long-term support.',
      },
      {
        step: 3,
        title: 'Spec & Pricing',
        description:
          'Final equipment specification, confirmed pricing, and lead time commitment from the manufacturer. No surprises after deposit.',
      },
      {
        step: 4,
        title: 'Production & Delivery',
        description:
          'We track production, coordinate shipping, and manage delivery logistics. You are not dealing with an overseas manufacturer\'s fulfillment team directly.',
      },
      {
        step: 5,
        title: 'Installation',
        description:
          'Our rigging team handles delivery, set, level, and commissioning. New equipment installation is included as an option with every new equipment order.',
      },
    ],
    bestFitScenarios: [
      {
        title: 'New Brewery Build',
        description:
          'Starting from scratch with a defined production volume and timeline? New equipment provides warranty coverage and known lead times that used equipment cannot guarantee.',
        icon: 'M12 4v16m8-8H4',
      },
      {
        title: 'Warranty Required',
        description:
          'Investor or lender requirements for new equipment warranty? We source factory-new systems with manufacturer documentation for capital-backed brewery builds.',
        icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
      },
      {
        title: 'Custom Configuration',
        description:
          'Need a non-standard vessel size, unusual utility configuration, or specific fabrication detail? Custom-spec new equipment is the right path when used inventory cannot match your requirements.',
      ...
      },
      {
        ...
        description:
          'Adding a second brewhouse or canning line to an existing facility? We can spec new equipment to match your existing utility infrastructure and production workflow.',
        icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6',
      },
    ],
    faqs: [
      ...
      {
        q: 'How does new equipment pricing compare to used?',
        a: 'New equipment carries a significant premium over comparable used systems. In most cases, a well-maintained used brewhouse from a working brewery offers better value per barrel of capacity. We provide honest guidance on the tradeoffs based on your specific situation.',
      },
    ],
