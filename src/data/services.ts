...
Contact us to describe your situation and we will advise on what consulting engagement structure makes sense.`,
    ...
    faqs: [
      ...
      { q: 'What does a consulting engagement typically cost?', a: 'Scope and cost depend on the engagement type. A single-session equipment evaluation is priced differently from a multi-week new brewery build project. We discuss scope and structure upfront before any commitment.' },
      { q: 'Can you provide independent equipment valuations for lenders or investors?', a: 'Yes. We provide independent equipment condition assessments and valuations for investors and lenders evaluating brewery acquisitions or using equipment as loan collateral. Contact us to discuss your specific situation.' },
    ],
...
Contact us to discuss your new equipment requirements. We can help with specification, pricing, and lead time estimates from our manufacturer relationships.`,
    ...
    faqs: [
      ...
      { q: 'Do you source new fermenters and canning lines in addition to brewhouses?', a: 'Yes. Through our manufacturer relationships we can source new fermentation vessels, canning lines, and supporting equipment in addition to complete brewhouse systems. Contact us with your specific requirements.' },
      { q: 'Can you work with manufacturers outside of Marks and Specific Mechanical?', a: 'Yes. Marks and Specific Mechanical are our primary relationships, but we work with other manufacturers based on your requirements, timeline, and budget. We source what fits the project, not what we have on the shelf.' },
    ],
