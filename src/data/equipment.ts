...
All fermentation vessels can be shipped nationwide. Rigging and installation services are available for multi-vessel moves and facility builds. Contact us for current availability and lead times.`,
    ...
    featuredItems: [
      ...
      { name: '30 BBL Conical Fermenter', price: '$18,500', condition: 'Used', category: 'FERMENTER',  image: 'fermenters-carbonation-skid.webp' },
      { name: '15 BBL Brite Tank',        price: '$9,800',  condition: 'Used', category: 'BRITE TANK', image: 'fermenters-cip-cart.webp' },
    ],
    buyerGuide: [
...
All equipment ships nationwide. Rigging, installation, and commissioning services available. Contact us to confirm current canning inventory and lead times.`,
    ...
    featuredItems: [
      { name: 'Wild Goose WGC-250 Canning Line',          price: '$112,000', condition: 'New',  category: 'CANNING LINE', image: 'canning-wild-goose-filler.webp' },
      { name: 'GAI Counter-Pressure Can Filler',           price: '$38,000',  condition: 'Used', category: 'CANNING LINE', image: 'canning-gai-counter-pressure.webp' },
      { name: 'TriPack LSA 160 Shrink Sleeve Applicator', price: '$14,000',  condition: 'Used', category: 'PACKAGING',    image: 'canning-khs-innofill.webp' },
    ],
    buyerGuide: [
...
Contact us for current glycol chiller inventory. We can also source specific tonnage ranges on request.`,
    ...
    featuredItems: [
      { name: 'G&D Glycol Chiller — 3 Ton',          price: '$8,500',  condition: 'Used', category: 'CHILLER', image: 'chiller-glycol-unit-1.webp' },
      { name: 'Pro Refrigeration Chiller — 5 Ton',   price: '$14,200', condition: 'Used', category: 'CHILLER', image: 'chiller-glycol-unit-2.webp' },
      { name: 'Glycol Chiller Unit — 10 Ton',        price: '$22,000', condition: 'Used', category: 'CHILLER', image: 'chiller-glycol-unit-3.webp' },
    ],
    buyerGuide: [
...
Contact us for current distillery equipment availability. We can also assist with sourcing specific still configurations on request.`,
    ...
    featuredItems: [
      { name: '300 Gallon Copper Pot Still',                    price: '$75,000', condition: 'Used', category: 'STILL',         image: 'distilling-copper-still.webp' },
      { name: 'Barison Continuous Column & 2,000L Batch Still', price: '$95,000', condition: 'Used', category: 'STILL',         image: 'distilling-barison-column.webp' },
      { name: 'Specific Mechanical Distilling Mash Tun',        price: '$28,500', condition: 'Used', category: 'DISTILLERY',    image: 'hero-distilling.webp' },
    ],
    buyerGuide: [
...
Used kegs from our inventory are sourced from production breweries and arrive with legitimate brewing history. New kegs from select manufacturers are also available. Contact us for volume pricing on bulk keg purchases.`,
    ...
    featuredItems: [
      { name: 'Half Barrel Stainless Kegs',     price: '$85 each',  condition: 'Used', category: 'HALF BARREL', image: 'kegs-half-barrel.webp' },
      { name: 'Stainless Keg Stack — Mixed Lot', price: 'Call',     condition: 'Used', category: 'MIXED LOT',   image: 'kegs-stainless-stack.webp' },
      { name: 'Pallet Lot — Half Barrel Kegs',  price: 'Call',      condition: 'Used', category: 'PALLET LOT',  image: 'kegs-pallet-stack.webp' },
    ],
    buyerGuide: [
...
Used boilers in our inventory are sourced from working production facilities. Condition documentation, nameplate specs, and operational history are provided where available. New Sussman electric boilers represent a code-compliant, lower-installation-complexity option for facilities where natural gas or steam systems are constrained.`,
    ...
    featuredItems: [
      { name: 'Commercial Steam Boiler — 15 BHP',  price: '$6,500',  condition: 'Used', category: 'BOILER', image: 'boiler-commercial-1.webp' },
      { name: 'Commercial Steam Boiler — 30 BHP',  price: '$11,000', condition: 'Used', category: 'BOILER', image: 'boiler-commercial-2.webp' },
      { name: 'Commercial Steam Boiler — 50 BHP',  price: '$18,500', condition: 'Used', category: 'BOILER', image: 'boiler-commercial-3.webp' },
    ],
    buyerGuide: [
...
Used cold room panels and refrigeration units from our inventory are typically sourced from food and beverage facility liquidations. Condition includes panel integrity, gasket condition, and refrigeration unit operational status. Contact us for current cold room inventory and custom configuration options.`,
    ...
    featuredItems: [
      { name: 'Walk-In Cold Room — Taproom Size',       price: '$8,500',  condition: 'Used', category: 'COLD ROOM', image: 'cold-room-walkin-1.webp' },
      { name: 'Production Walk-In Cooler',              price: '$18,000', condition: 'Used', category: 'COLD ROOM', image: 'cold-room-walkin-2.webp' },
      { name: 'Large-Format Cold Room — Distribution', price: '$32,000', condition: 'Used', category: 'COLD ROOM', image: 'cold-room-walkin-3.webp' },
    ],
    buyerGuide: [
