...
export default config({
  ...
  ui: {
    ...
    navigation: {
      ...
      Pages: ['homePage', 'aboutPage', 'servicesPage', 'equipmentPage', 'industriesPage', 'locationsPage', 'blogPage', 'contactPage', 'privacyPage', 'termsPage', 'thankYouPage'],
  ...
  singletons: {
    ...
    homePage: pageSingleton('Home', 'src/content/pages/home', homePage),
    aboutPage: pageSingleton('About', 'src/content/pages/about', aboutPage),
    ...
    locationsPage: pageSingleton('Locations Landing', 'src/content/pages/locations', locationsPage),
    blogPage: pageSingleton('Blog Landing / Post Labels', 'src/content/pages/blog', blogPage),
    contactPage: pageSingleton('Contact', 'src/content/pages/contact', contactPage),
    privacyPage: pageSingleton('Privacy', 'src/content/pages/privacy', privacyPage),
    termsPage: pageSingleton('Terms', 'src/content/pages/terms', termsPage),
    thankYouPage: pageSingleton('Thank You', 'src/content/pages/thank-you', thankYouPage),
  },
  collections: {
